...
public class MenuTest {
    ...
    public void test_csvSortedByCategoryThenPriceDescendingThenByName() {
        String expected = "Boba Tea,249,Beverage" + nl + "Milk Tea,249,Beverage" + nl + "Green Tea,149,Beverage" + nl
    ...
    public void test_csvSortedByCategoryThenName() {
        String expected = "Boba Tea,249,Beverage" + nl + "Green Tea,149,Beverage" + nl + "Milk Tea,249,Beverage" + nl
                + "Large Poke Bowl,1449,Poke Bowls" + nl + "Medium Poke Bowl,1249,Poke Bowls" + nl
                + "Small Poke Bowl,1049,Poke Bowls" + nl + "";
